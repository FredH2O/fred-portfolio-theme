<footer class="site-footer">
    ...
    <div class="site-footer-grid">
        <div class="site-first-grid">
            ...
            <div>
                <p>
                    A junior WordPress developer creating clean,
                    user-friendly websites with a focus on simplicity,
                    clarity, and solid code.
                </p>
            </div>
    ...
    <div>
        <p>Copyright &copy;<?php ?>, fredcodes.com,All Rights Reserved.</p>
    </div>
</footer>